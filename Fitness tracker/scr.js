class WorkoutTracker {
    ...
    static rowHtml() {
        return `
            <tr class="tracker__row">
                ...
                <td>
                <input type="number" class="tracker__calorie">
    ...
    updateView() {
        ...
        const addRow = data => {
            ...
            row.querySelector(".tracker__calorie").value = data.calorie;
            ...
            row.querySelector(".tracker__calorie").addEventListener("change", ({ target }) => {
                data.calorie = target.value;
                this.saveEntries();
            });
